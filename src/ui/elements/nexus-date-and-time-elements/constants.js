...
export const BUSINESS_DATE_TIME_FORMAT = ' hh:mm:ss A [(UTC)]';
export const REGIONAL_DATE_TIME_FORMAT = ' hh:mm:ss A';
export const TIMESTAMP_FORMAT = ' hh:mm:ss.SSS A [(UTC)]';
export const ATLASKIT_DATE_FORMAT = 'YYYY-MM-DD[T]HH:mm';
export const SIMULCAST_DATE_FORMAT = 'YYYY-MM-DD[T]HH:mm:ss[Z] [(UTC)]';
