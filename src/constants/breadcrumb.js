...
export const AVAILS_DASHBOARD = {name: 'Avails Dashboard', path: '/avails', search: search, onClick: () => gotoAvailsDashboard()};
...
export const AVAILS_HISTORY_SEARCH_RESULTS = {name: 'Avails Ingest History > Search Results', path: '/avails/history', search: search};
export const RIGHT_CREATE = {name: 'Create Right', path: 'avails/rights/create', search: search};
export const RIGHTS_CREATE_FROM_PDF = {name: 'Manual Rights Entry', path: '/avails/history/manual-rights-entry', search: search};
