        ...
        <div>
            ...
            {language === undefined ? (
                <div className="nexus-jb-lang-label">
                    <SectionMessage title="Data not available">
                        <p>Language not available with this order.</p>
                    </SectionMessage>
                </div>
            ) : (
                <div>
                    <label htmlFor="jb-lang" className="nexus-jb-lang-label">
                        <h4>Language: </h4>
                    </label>
                    ...
                    {!isDisabled && <HelperMessage>Type to change language</HelperMessage>}
                </div>
            )}
        </div>
    );
