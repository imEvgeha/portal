...
const ServiceOrderFilter = ({
    ...
    return (
        <div className="so-panel-filter-detail">
            <span className="so-panel-filter-detail__span nexus-c-table-toolbar__title--is-active">
                Customer: {orderDetails.tenant}
            </span>
            <p className="so-panel-filter-detail__p nexus-c-table-toolbar__title--is-active">
