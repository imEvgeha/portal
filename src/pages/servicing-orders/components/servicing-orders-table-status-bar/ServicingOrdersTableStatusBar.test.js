...
describe('ServicingOrdersTableStatusBar', () => {
    ...
    it('should show the selected row label if there are selected rows', () => {
        ...
        const selectedRowsText = wrapper
            .find('.nexus-c-servicing-orders-table-status-bar__info')
            .at(1)
            .text();
    ...
    it('should not show the selected row label if there are no selected rows', () => {
        ...
        const selectedRowsNode = wrapper.find('.nexus-c-servicing-orders-table-status-bar__info').at(1).length;
    ...
    it('should show the correct number of total rows', () => {
        ...
        const totalRowsText = wrapper.find('.nexus-c-servicing-orders-table-status-bar__info').at(0).text();
