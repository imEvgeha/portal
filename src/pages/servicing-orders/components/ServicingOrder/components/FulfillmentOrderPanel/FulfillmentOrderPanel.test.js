...
import ServicingOrderPanel from './ServicingOrderPanel';
...
describe('FulfillmentOrderPanel', () => {
    ...
    beforeEach(() => {
        ...
        attachments = [{
                ...
                link: 'https: //vbq-cs-qa.s3.us-west-2.amazonaws.com/avails/archive/d8fa01e1-a9b6-454d-84f8-3d13ffce6e86/INT_avails_20k_(1).xlsx',
                downloadUrl: null,
                status: 'COMPLETED',
                errorReports: null,
                ingestReport: {
            ...
            },
            {
                ...
                updatedBy: '62ee67dc-509f-4b07-8c36-b0753a28b203',
                attachmentType: 'Excel',
                link: 'https://vbq-cs-qa.s3.us-west-2.amazonaws.com/avails/archive/73ea9f26-9700-62cb-3ca0-b697fe519775/lgusa_1_multifile_ingestion_3.xlsx',
                downloadUrl: null,
                status: 'FAILED',
                errorReports: null,
                ingestReport: {
            ...
            },
            {
                ...
                link: 'https://vbq-cs-qa.s3.us-west-2.amazonaws.com/avails/archive/73ea9f26-9700-62cb-3ca0-b697fe519775/mail.eml',
                downloadUrl: null,
                status: 'COMPLETED',
                errorReports: null,
                ingestReport: null
            },
            {
                ...
                updatedBy: '62ee67dc-509f-4b07-8c36-b0753a28b203',
                attachmentType: 'Email',
                link: 'https://vbq-cs-qa.s3.us-west-2.amazonaws.com/avails/archive/73ea9f26-9700-62cb-3ca0-b697fe519776/mail.eml',
                downloadUrl: null,
                status: 'COMPLETED',
                errorReports: null,
                ingestReport: null
        ...
        wrapper = shallow(<ServicingOrderPanel {...props} />);
    });
