...
export const searchFormUpdateAdvancedHistorySearchCriteria = searchCriteria => ({type: HISTORY_SEARCH_FORM__UPDATE_ADVANCED_SEARCH_CRITERIA, payload: searchCriteria});
export const searchFormSetAdvancedHistorySearchCriteria = searchCriteria => ({type: HISTORY_SEARCH_FORM__SET_ADVANCED_SEARCH_CRITERIA, payload: searchCriteria});
export const searchFormSetHistorySearchCriteria = searchCriteria => ({type: HISTORY_SEARCH_FORM__SET_SEARCH_CRITERIA, payload: searchCriteria});
